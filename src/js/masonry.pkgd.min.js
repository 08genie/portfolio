/* ! Masonry PACKAGED v4.1.1 Cascading grid layout library
...
!function (t, e) {
    ...
    function i(i, r, a) {
        ...
        a = a || e || t.jQuery,
            a && (
                r.prototype.option || (r.prototype.option = function (t) {
            ...
            i.docReady(function () {
                ...
                u.forEach(function (t) {
                    ...
                    try {
                        ...
                        return void (
                            n && n.error("Error parsing " + s + " on " + t.className + ": " + a)
                        )
                    }
                    var h = new e(t, i);
                    l && l.data(t, o, h)
    ...
    function (t, e) {
        ...
        var r = document.documentElement.style,
            s = "string" == typeof r.transition
                ? "transition"
                : "WebkitTransition",
            a = "string" == typeof r.transform
                ? "transform"
                : "WebkitTransform",
            h = {
    ...
    function (t, e) {
        ...
        return i.compatOptions.fitWidth = "isFitWidth",
            ...
            i.prototype._manageStamp = function (t) {
                ...
                for (var u = this._getOption("originTop"), d = (
                    u
                        ? n.top
                        : n.bottom
                ) + i.outerHeight, l = a; h >= l; l++)
